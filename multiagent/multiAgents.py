...
class ReflexAgent(Agent):
    ...
    def evaluationFunction(self, currentGameState: GameState, action):
        ...
        manhattan_distances_for_food=[util.manhattanDistance(newPos, f) for f in list_of_food]
        manhattan_distances_for_ghosts=[util.manhattanDistance(newPos, g.getPosition()) for g in newGhostStates]
...
class MinimaxAgent(MultiAgentSearchAgent):
    ...
    """ The implementation of the functions is based on the pseudocode and further information is adder for the functionality """
...
class AlphaBetaAgent(MultiAgentSearchAgent):
    ...
    """ The code for this algorithm is obtained by modifying the Minimax algorithm, we need to add alpha and beta """
